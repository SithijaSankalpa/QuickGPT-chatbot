    ...
    {/* Chat Messages*/ }
      <div ref={containerRef} className='flex-1 mb-5 overflow-y-scroll'>
        ...
        {/* Three Dots Loading */ }
        {
          loading && <div className='loader flex items-center gap-1.5'>
            ...
            {mode === 'image' &&(
          <div className='flex justify-center mb-3'> {/* Better centering wrapper */}
            <label className='inline-flex items-center gap-2 text-sm cursor-pointer'> {/* Added cursor-pointer to label */}
      ...
      gap-4 items-center'>
        ...
        <button disabled={loading}>
          <img src={loading ? assets.send_icon : assets.send_icon} alt="" />
        </button>
      </form>
    </div>
  )
